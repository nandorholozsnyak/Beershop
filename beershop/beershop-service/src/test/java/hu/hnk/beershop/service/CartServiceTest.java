...
public class CartServiceTest {
	...
	public void testSaveItemsToCartEmptyCart() throws Exception {
		...
		// Definiáljuk a raktárban lévő söröket.
		...
		// A visszavárt sörök, amelyek mint kosár tárgyak helyeződnek a kosárba.
	...
	public void testSaveItemsToCartWithOneItemInIt() throws Exception {
		...
		// Belerakjuk az első sört, 10 darabszámmal.
		Map<Beer, Integer> beersToCart = new HashMap<>();
		beersToCart.put(firstBeer, 10);
		...
		// A legelső elemet várjuk ami benne van a mi kosarunkban.
		// Már szerepel egy ilyen termék, a 10 darabszámmal a kosárban most azt
		// várjuk hogy ezután 20 darab lesz belőle.
		CartItem firstExpected = new CartItem();
		firstExpected.setBeer(firstBeer);
