...
public interface StorageService {
	...
	/**
	 * Meghívja a raktár adathozzáférési objektumának a mentését, amely a listában szereplő összes módosítást menti.
	 * @param storage a raktárban szereplő elemek listája.
